      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={cn("transition-all duration-700", isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8")}>
            ...
            <p className="text-lg leading-relaxed mb-6 text-muted-foreground">Through my experience of 37 years as a Business, Design, and Construction professional, I have found that exceptional results come from exceptional teams.</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-serif text-charcoal text-xl">Michael Chandler</p>
                <p className="text-primary text-base">Founder & Master Builder</p>
              </div>
            </div>
          </div>
