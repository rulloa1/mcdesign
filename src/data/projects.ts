...
export const projects: Project[] = [
  ...
  // 19. Civil Engineering
  {
    ...
    role: "Civil Engineering Contractor, Builder, Project Manager, Permit Procurement",
    description:
      "A comprehensive civil engineering and site development project showcasing our expertise in grading, earthwork, drainage systems, and infrastructure construction. Our team coordinated heavy equipment operations, engineered retaining solutions, and managed all phases of site preparation to deliver a fully improved property ready for development. Precision, compliance, and craftsmanship defined every stage of this project.",
    gallery: [
