...
import woodPanelingImg from "@/assets/detail-wood-paneling.png";
  ...
  return <Layout>
    ...
    <section className="relative pt-32 pb-32 overflow-hidden">
      ...
      <div
        ...
        className={`container relative z-10 mx-auto px-6 transition-all duration-700 ${heroAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
      >
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-charcoal hover:text-primary transition-colors mb-8 group font-medium"
        >
        ...
        <p className="text-charcoal/80 text-lg mb-6 max-w-xl">
